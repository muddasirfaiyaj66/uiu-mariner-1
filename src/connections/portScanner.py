...
class PixhawkPortScanner:
    ...
    DEFAULT_SERIAL_PORTS = [
        "/dev/ttyACM0",  # USB CDC devices (Pixhawk most common)
        ...
        "/dev/serial0",  # Raspberry Pi primary serial
    ...
    DEFAULT_BAUD_RATES = [
        115200,  # Most common for Pixhawk (default)
        57600,  # Alternative common rate
        921600,  # High-speed
